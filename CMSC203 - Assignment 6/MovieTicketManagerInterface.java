...
public interface MovieTicketManagerInterface 
{
	 ...
	 * @param id the identification number of the buyer 
	 ...
	 * @param id the identification number of the buyer
	 * @return the number of times the patron had seen this movie
	 */
	public int numThisMovie(int id, String movie);
	
	/**
	 * Checks to see if this patron already saw a movie today
	 * @param id the identification number of the patron
 ...
 * @param t time
 * @param f format
 * @param type type of the patron such as Adult, Child, Employee or MoviePass
 * @param id identification number of the patron
 ...
 */
	...
	/**
	 * Returns the report of all tickets sold in the entire month
	 * @return the report of all tickets sold in the entire month
	 */
